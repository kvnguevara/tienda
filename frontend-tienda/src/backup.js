    ...
    <div className="form-vender-articulo">
      ...
      <div className="form-vender-articulo__titulo">
        <label className="form__label dblock">
          {"Eleg\u00ed un t\u00edtulo para tu art\u00edculo"}
        </label>
      ...
      <div className="form-vender-articulo__descripcion">
        <label className="form__label dblock">
          {"Escrib\u00ed una descripci\u00f3n detallada:"}
        </label>
      ...
      <div className="form-vender-articulo__descripcion">
        <label className="form__label dblock">
          {"Escog\u00e9 al menos una imagen para tu producto."}
        </label>
        <SeleccionarArchivos />
      </div>
    </div>
  ...
  return (
    <div className="banner roboto-c dflex border-box of-x-hidden">
      ...
      <section className="banner__cuenta-usuario dflex">
        <a
          href="/ingresar"
          className="banner__cuenta-usuario__anchor cursor-pointer"
        >
          Iniciar Sesión
        </a>
        <a
